          ...
          <div className="flex w-full flex-col self-stretch items-stretch my-auto max-md:mt-10">
            ...
            <div className="flex items-center gap-2 mt-5">
              <img
                ...
                alt="Social 1"
                className="aspect-[1] object-contain w-[26px] self-stretch shrink-0 my-auto rounded-[5px]"
              />
              <img
          ...
          <div className="flex w-full flex-col max-md:max-w-full max-md:mt-10">
            <div className="flex w-[520px] max-w-full flex-col items-stretch">
                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
                  <div className="w-[22%] max-md:w-full max-md:ml-0">
                    <nav className="flex grow flex-col items-stretch text-base max-md:mt-10">
                      <h3 className="text-[#F2F2F2] text-center font-medium">
                        Quick Links
                      </h3>
                      <ul className="w-full text-[rgba(242,242,242,1)] font-normal mt-[31px]">
                        <li className="mt-[11px]">About</li>
                        <li className="mt-[11px]">Community</li>
                        <li className="mt-[11px]">Join US</li>
                      </ul>
                    </nav>
                  </div>
                  <div className="w-[78%] ml-5 max-md:w-full max-md:ml-0">
                    <div className="w-full max-md:mt-10">
                      <div className="flex w-[178px] max-w-full flex-col items-stretch text-base ml-[11px] max-md:ml-2.5">
              ...
              <div className="flex items-center gap-[37px] text-base text-[rgba(242,242,242,1)] font-normal mt-[75px] max-md:mt-10">
                <a href="#privacy" className="self-stretch my-auto">
                  Privacy
                </a>
                <a href="#terms" className="self-stretch my-auto">
                  Terms of Service
                </a>
              </div>
            </div>
